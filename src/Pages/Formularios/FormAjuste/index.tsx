...
import { Aviso, Btns, CardForm, ContainerForm, Hospital, Imagem, Logo, NmItem, NmItemNumero, Radios, Solicitante, Top } from "../FormMaterial/styles";
    ...
    async function registrarEvento (event: any) {
        ...
        if(parado === ''|| selectedValue === ''|| equipamento === ""){
            ...
            try{
                ...
                const response = await api.post('/form/ajuste', {nm_usuario: `${userMaiusculo}`, nr_contato:`${ramal}`, titulo_p: `${ajuste}`, descricao_p:`${obs}`, ie_parado:`${parado}`, dt_inicio_desejado:`${dataOficial}`, nr_seq_localizacao:`${selectedValue}`, nr_seq_equipamento:`${equipamento}`, nr_grupo_planej:`${grupoPlanejamento}`, nr_grupo_trabalho:`${grupoTrabalho}`})
                ...
                <div className="meio">
                    <form onSubmit={handleSubmit(registrarEvento)}>
                        ...
                        <NmItem>
                            ...
                            <Aviso>
                                <p>Neste campo informe qual setor receberá sua solicitação.</p>
                            </Aviso>
                        </NmItem>
                        <NmItem >
